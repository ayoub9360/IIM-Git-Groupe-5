    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to the presentation of our team on this Git project
        </h2>
        <p class="mt-3 text-gray-600">
          We have choose the nuxt framework to discover how to use Git and Github. To know more about this framework go to the <a href="https://nuxtjs.org" target="_blank" class="text-green-500 hover:underline">Nuxt documentation</a>.<br>
        </p>
        <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
          Start to discover our team by navigate on the nav bar or with theses following links :
        </p>
        <ul>
          <li><nuxt-link to="kevin" class="text-green-500 hover:underline"> - Kevin</nuxt-link></li>
          <li><nuxt-link to="malo" class="text-green-500 hover:underline"> - Malo</nuxt-link></li>
          <li><nuxt-link to="tom" class="text-green-500 hover:underline"> - Tom</nuxt-link></li>
          <li><nuxt-link to="mathilde" class="text-green-500 hover:underline"> - Mathilde</nuxt-link></li>
          <li><nuxt-link to="ayoub" class="text-green-500 hover:underline"> - Ayoub</nuxt-link></li>
        </ul>
      </div>
